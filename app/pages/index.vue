...
import { type RecipeRespones } from '~~/types/types';

const { data, error } = await useFetch<RecipeRespones>('https://dummyjson.com/recipes?limit=12');
    ...
    <main>
        <section class="bg-[#f1f1f1]">
            <div class="container flex flex-col lg:flex-row items-center py-20 gap-10">
                ...
                <div class="flex-1 order-1 lg:order-2">
                    <NuxtImg src="/nuxt-course-hero.png" densities="x1" alt="food" format="webp"
        ...
        <section class="py-20 container">
            ...
            <p v-else class="text-xl">
                Opps, somthing went wrong. Please try again later.
            </p>
        </section>
    </main>
</template>
